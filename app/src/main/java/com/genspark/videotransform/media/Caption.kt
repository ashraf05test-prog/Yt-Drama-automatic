...
/**
 * Native Android replacement for the ImageMagick `magick` caption pass in
 * the original web project. Renders a transparent PNG sized to the output
 * frame so FFmpeg can simply overlay it at 0,0 — same contract as caption.ts.
 */
